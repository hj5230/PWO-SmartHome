    ...
    return (
      <>
        <Navbar bg="light" expand="lg">
          <Container>
            <Button size="sm" variant="link" onClick={this.toggleSidebar}>
              <svg
        ...
        <div className="panel">
          <OverlayTrigger
            ...
            placement="bottom"
            overlay={
              <ListGroup className="device-panel">
                <ListGroup.Item action onClick={this.handlePair}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
          ...
          >
            <Button variant="outline-primary" style={{ marginBottom: 20 }}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
          ...
          <br />
          <Figure.Image width={350} src={png} />
        </div>
        <div
        ...
        >
          <div className="sidebar-content" onClick={(e) => e.stopPropagation()}>
            <ListGroup>
              ...
              <ListGroup.Item onClick={this.handleClick}>Settings</ListGroup.Item>
            </ListGroup>
          </div>
        </div>
      </>
